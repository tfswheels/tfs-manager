...
script_dir = pathlib.Path(__file__).parent.parent.parent  # Go up to TFS Manager root
env_paths = [
    script_dir / '.env',  # TFS Manager/.env
    pathlib.Path.home() / '.tfs_manager.env',  # ~/.tfs_manager.env
    pathlib.Path('/Users/jeremiah/Desktop/TFS Wheels/Scripts/.env'),  # Legacy location
]
