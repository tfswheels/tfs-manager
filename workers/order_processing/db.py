...
script_dir = EnvPath(__file__).parent.parent.parent  # Go up to TFS Manager root
env_paths = [
    script_dir / '.env',  # TFS Manager/.env
    EnvPath.home() / '.tfs_manager.env',  # ~/.tfs_manager.env
    EnvPath('/Users/jeremiah/Desktop/TFS Wheels/Scripts/.env'),  # Legacy location
]
